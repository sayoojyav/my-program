...
Route::post('/data',[\App\Http\Controllers\DataController::class,'store'])->name('store');
Route::get('/data/view/{id}', [\App\Http\Controllers\DataController::class, 'view'])->name('data.view');